...
%
% Usage: 
%   >> cell_inputs = userInput_cellArray(indx, cell_inputs)
%
% Inputs:
...
function cell_inputs = userInput_cellArray(indx, cell_inputs)
    % Prompt the user to enter the cell elements, and store the input in
    % the cell_inputs cell array. If the user enters 'done' (case
    % insenstive), no more elementss can be entered and duplicates are 
    % removed from the list. Will continue until 'done' is entered, 
